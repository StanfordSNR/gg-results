// GGHASH:V9w_.SkOBr.MYXB5VxmXZFWsSIIoD0FsMbt3rq9MxL2U00005f7f
...
#define XSRETURN(off) STMT_START { const IV tmpXSoff = (off); assert(tmpXSoff >= 0); PL_stack_sp = PL_stack_base + ax + (tmpXSoff - 1); return; } STMT_END
