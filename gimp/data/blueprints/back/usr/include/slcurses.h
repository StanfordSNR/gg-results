// GGHASH:VmtK.68P01OS9hdJdWJ8rDhEoTDpf7CF6UpTMvCuLxkQ00003072
#include <stdio.h>
...
#define mvwaddnstr(w,y,x,s,n) (-1 == wmove((w),(y),(x)) ? -1 : waddnstr((w),(s),(n)))
#define mvwaddstr(w,y,x,s) (-1 == wmove((w),(y),(x)) ? -1 : waddnstr((w),(s), -1))
#define mvaddnstr(y,x,s,n) mvwaddnstr(stdscr,(y),(x),(s),(n))
#define mvaddstr(y,x,s) mvwaddstr(stdscr,(y),(x),(s))
#define mvwaddch(w,y,x,c) ((-1 == wmove((w),(y),(x))) ? -1 : waddch((w),(c)))
...
#define winch(w) ((((w)->_cury < (w)->nrows) && ((w)->_curx < (w)->ncols)) ? ((w)->lines[(w)->_cury][(w)->_curx].main) : 0)
#define inch() winch(stdscr)
#define mvwinch(w,x,y) ((-1 != wmove((w),(x),(y))) ? winch(w) : (-1))
...
#define winsertln(w) ((w)->scroll_min=(w)->_cury, (w)->scroll_max=(w)->nrows, wscrl((w), -1))
...
#endif
#define A_CHARTEXT 0x001FFFFFUL
#define A_NORMAL 0x00000000UL
#define A_UNUSED 0x00e00000UL
#define A_COLOR 0x0f000000UL
#define A_BOLD 0x10000000UL
#define A_REVERSE 0x20000000UL
#define A_STANDOUT A_REVERSE
#define A_UNDERLINE 0x40000000UL
#define A_ALTCHARSET 0x80000000UL
...
#define init_pair(_x,_f,_b) SLtt_set_color_fgbg ((_x), (((_f) == (_b)) ? 7 : (_f)), (((_f) == (_b)) ? 0 : (_b)))
#else
#define init_pair(_x,_f,_b) SLtt_set_color_object((_x), ((_f) == (_b) ? 0x0700 : ((_f) | ((_b) << 8)) << 8))
#endif
