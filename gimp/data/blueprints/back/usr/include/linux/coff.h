// GGHASH:VLH3Zl4MkGZWHzPhmgJPPe.VG7izVA6oZv0NTujy.7Ss000030bc
#define E_SYMNMLEN 8
...
#define COFF_I386BADMAG(x) ((COFF_SHORT((x).f_magic) != COFF_I386MAGIC) && COFF_SHORT((x).f_magic) != COFF_I386PTXMAGIC && COFF_SHORT((x).f_magic) != COFF_I386AIXMAGIC)
#else
