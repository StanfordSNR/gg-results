// GGHASH:V5yGMyMyWmvJW6jB5ILz5NoYK7edXNMgzGaLwXBjqKlQ00001bfb
#ifndef _COMPLEX_H
#define _COMPLEX_H 1
...
#define CMPLXF128X(x,y) __builtin_complex ((_Float128x) (x), (_Float128x) (y))
#endif
...
#undef _Mdouble_
#undef __MATH_PRECNAME
#if !(defined __NO_LONG_DOUBLE_MATH && defined _LIBC) || defined __LDBL_COMPAT
# ifdef __LDBL_COMPAT
#undef __MATHDECL_1
#define __MATHDECL_1(type,function,args) extern type __REDIRECT_NTH(__MATH_PRECNAME(function), args, function)
# endif
