// GGHASH:Vr7l.D7gHGhbdEda7Unta3kWqzWbn1mtujjvP0rbEZhY0000af1b
...
#else
#define UTF8_CHAR_LENGTH(c) ((uint32_t)(c)<=0x7f ? 1 : ((uint32_t)(c)<=0x7ff ? 2 : ((uint32_t)(c)<=0xffff ? 3 : ((uint32_t)(c)<=0x10ffff ? 4 : ((uint32_t)(c)<=0x3ffffff ? 5 : ((uint32_t)(c)<=0x7fffffff ? 6 : 3) ) ) ) ) )
#endif
