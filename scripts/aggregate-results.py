...
def latex_main_results(results_dir):
    data = generate_tables(results_dir)
    ...
    print(r'%')
    print()
    print(r'\begin{figure*}[htpb]')
    print(r'\centering\fontsize{9}{10}\selectfont')
    print(r'\begin{tabular}{l %s}' % (' '.join(['c'] * len(target_tests))))
    ...
    print(r'\end{tabular}')
    print(r'\caption{\sys main results}')
    print(r'\end{figure*}')
...
def main(output_format, results_dir):
    if output_format == 'markdown':
        ...
        latex_main_results(results_dir)
    else:
